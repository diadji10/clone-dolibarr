...
import "../createType/createType.css";
...
function EditType() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8081/typedata/${ref}`).then((res) => {
      setLibelle(res.data[0].libelle);
      setEtat(res.data[0].etat === 1 ? true : false);
      setNature(res.data[0].nature);
      setCotisation(res.data[0].cotisation === 1 ? true : false);
      setMontant(res.data[0].montant);
      setToutMontant(res.data[0].tout_montant === 1 ? true : false);
      setVote(res.data[0].vote === 1 ? true : false);
  ...
  const handleSubmit = (e) => {
    ...
    if (libelle === "") {
      ...
      axios
        .put(`http://localhost:8081/edittype/${ref}`, {
          libelle,
          etat,
          nature,
          cotisation,
        ...
        <div className="bottom">
          ...
          <div className="main">
            <div className="container">
              ...
              <br />
              <form action="">
                <p htmlFor="" style={{ textAlign: "left", fontSize: "15px" }}>
                  Réf. : {ref}
                </p>
