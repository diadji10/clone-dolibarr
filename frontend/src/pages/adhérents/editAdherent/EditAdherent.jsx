...
import "../newAdherent/newAdherent.css";
...
function EditAdherent() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8081/opentype")
    ...
    axios
      ...
      .then((res) => {
        ...
        setNature(res.data[0]?.nature || "");
        setSociete(res.data[0].societe);
        setCivilite(res.data[0].civilite);
        setNom(res.data[0].nom);
        setPrenom(res.data[0].prenom);
        setGenre(res.data[0].genre);
        setEmail(res.data[0].email);
        setWeb(res.data[0].web);
        setCodePostal(res.data[0].code_postal);
        setVille(res.data[0].ville);
        setPays(res.data[0].pays === "" ? "Senegal" : res.data[0].pays);
        setDepartement(res.data[0].departement);
        setTelPro(res.data[0].tel_pro);
        setTelPerso(res.data[0].tel_perso);
        setTelPortable(res.data[0].tel_portable);
        setDate(res.data[0].date);
        setAdhesion(res.data[0].adhesion === 0 ? false : true);
  ...
  const handleSubmit = () => {
    if (nature === "" || nom === "" || prenom === "" || type === "") {
      alert("Veuillez remplir les champs type, nature, nom, prenom");
    } else {
      ("");
    }
  };
    ...
    <div>
      <div className="app">
        ...
        <div className="bottom">
          ...
          ></Sidebar>
          <div className="main new-adherent">
            <h1
              style={{
                padding: "15px",
                width: "95%",
            ...
            <form action="">
              <div className="line">
                <p style={{ color: "#3E1754", fontWeight: "bolder" }}>
                  Type d&apos;adhérent
                </p>
                <div className="right-part">
                  ...
                  >
                    ...
                    {dataType.map((el, index) => {
                      return (
                        <MenuItem value={el.libelle} key={index}>
                          {el.libelle}
                        </MenuItem>
                      );
                    })}
              ...
              <div className="line">
                ...
                <div className="right-part">
                  ...
                  <Autocomplete
                    ...
                    sx={{ width: "300px" }} // Largeur de l'Autocomplete
                    options={countries}
                    autoHighlight
                    value={
                      countries.find((country) => country.label === pays) ||
                      null
                    } // Trouve l'objet correspondant à la valeur stockée
                    onChange={(event, newValue) => {
                      setPays(newValue ? newValue.label : ""); // Assurez-vous que la valeur est une chaîne vide si `newValue` est null
                    }}
                    getOptionLabel={(option) => option.label || ""} // Affiche uniquement le nom du pays
                    isOptionEqualToValue={
                      (option, value) => option.label === value.label // Comparaison basée sur le nom du pays
                    }
                    renderOption={(props, option) => {
                      // Déstructure les propriétés pour éviter de passer la clé avec le spread
                      const { key, ...rest } = props;

                      return (
                        <Box
                          component="li"
                          key={option.code} // Assure-toi que la clé est passée directement
                          sx={{
                            display: "flex",
                            alignItems: "center",
                            padding: "8px",
                          ...
                          {...rest} // Passe les autres propriétés restantes
                        >
                          <img
                            loading="lazy"
                            width="20"
              ...
              <div className="line">
                ...
                <div className="right-part">
                  ...
                  <TextField
                    ...
                    sx={{ width: "130px", marginLeft: "13px" }}
                    InputProps={{
                      sx: {
                        height: "30px",
                      },
              ...
              <div className="line">
                <p>Tél Portable</p>
                <div className="right-part">
                  <PhoneIphoneIcon style={{ color: "#7C7C4D" }} />
                  <TextField
                    id="outlined-number"
                    label="Number"
                    type="number"
              ...
              <div className="line">
                <p>Adhésion publique</p>
                <div className="right-part">
                  <Select
                    value={adhesion}
                    onChange={(e) => setAdhesion(e.target.value)}
                    displayEmpty
                    inputProps={{ "aria-label": "Without label" }}
